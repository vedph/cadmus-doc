...
- [exporting an RDF graph](export/graph/graph.md). This projects data into an RDF graph using any ontologies. The graph is kept in synch with editor data whenever this gets updated.
