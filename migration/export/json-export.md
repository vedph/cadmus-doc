...
Exporting JSON differs from a [raw JSON export](json-raw) as it implies selecting and remapping source data into a different JSON schema. So here we are effectively _transforming_ source data into any other schema, as required by the consumer.
