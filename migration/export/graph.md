...
In a sense, just like you might be able to create (via [rendering](rendition/architecture)) a full-fledged TEI document without even knowing about XML, this subsystem allows you to create an RDF graph without even knowing about semantic web.
