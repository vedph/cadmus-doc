...
- a [metadata part](https://github.com/vedph/cadmus-general/blob/master/docs/metadata) in this item, including an `eid` metadatum with the person's user-friendly ID.
...
- a Cadmus item representing a person, whose facet is named `person`.
- a [metadata part](https://github.com/vedph/cadmus-general/blob/master/docs/metadata) in this item, including an `eid` metadatum with the person's user-friendly ID.
- an [events part](https://github.com/vedph/cadmus-general/blob/master/docs/historical-events) in this item, including an event of type `person.birth`.
